...
<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
    ...
    <div class="mb-6 md:mb-8">
      ...
      <p class="max-w-screen-md text-gray-500 md:text-lg text-center mx-auto">最近行った温泉でお気に入りの温泉があれば是非投稿してください！<br>説明欄にはイチオシポイントや、持っていった方がいいものや注意点などを記述しましょう！<br>
      <span class="text-xs text-red-500">*は必須項目です。</span>
      </p>
    </div>
    ...
    <form class="max-w-screen-md grid sm:grid-cols-3 gap-4 mx-auto" action="{{ route('review.store') }}" method="POST" enctype="multipart/form-data">
      ...
      <div class="sm:col-span-3">
        <label for="title" class="font-bold inline-block text-gray-800 text-sm sm:text-base mb-2">施設名<span class="ml-1 text-sm text-red-500">*</span></label>
      ...
      <div>
        <label for="lscore" class="inline-block text-gray-800 text-sm sm:text-base mb-2">おすすめ度<span class="ml-1 text-sm text-red-500">*</span></label>
      ...
      <div class="">
        <label for="tag" class="inline-block text-gray-800 text-sm sm:text-base mb-2">エリア<span class="ml-1 text-sm text-red-500">*</span></label>
      ...
      <div class="flex flex-col">
        ...
        <input type = "text" name="freetag" class="w-full  text-gray-800 border-1 focus:outline-none ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" placeholder="例：福岡、サウナ、露天風呂">
